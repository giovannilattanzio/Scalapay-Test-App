  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'DetectedMerchant':
          return DetectedMerchant.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ErrorDetail':
        ...
        case 'FacetCount':
          return FacetCount.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'FacetStats':
        ...
        case 'GroupedHit':
          return GroupedHit.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Hit':
          return Hit.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProductDocument':
          return ProductDocument.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProductSearchResponse':
          return ProductSearchResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        default:
          RegExpMatch? match;
